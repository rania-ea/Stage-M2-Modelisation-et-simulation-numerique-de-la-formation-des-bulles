...
# sols = np.array(sols)
# np.save("matrice_des_min_2.npy", sols)

sols = np.load("matrice_des_min_2.npy", allow_pickle=True)

sols_x = np.array([sols[i].x for i in range(1000)])
sols_fun = np.array([sols[i].fun for i in range(1000)])
